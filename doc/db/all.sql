...
(
  ...
  default charset = utf8mb4 comment ='课程大章';

insert into `chapter` (id, course_id, name)
values ('00000003', '00000003', '测试章节03');
insert into `chapter` (id, course_id, name)
values ('00000004', '00000004', '测试章节04');
insert into `chapter` (id, course_id, name)
values ('00000005', '00000005', '测试章节05');
insert into `chapter` (id, course_id, name)
values ('00000006', '00000006', '测试章节06');
insert into `chapter` (id, course_id, name)
values ('00000007', '00000007', '测试章节07');
insert into `chapter` (id, course_id, name)
values ('00000008', '00000008', '测试章节08');
insert into `chapter` (id, course_id, name)
values ('00000009', '00000009', '测试章节09');
insert into `chapter` (id, course_id, name)
values ('00000010', '00000010', '测试章节10');
insert into `chapter` (id, course_id, name)
values ('00000011', '00000011', '测试章节11');
...
# 课程内容  大字段 经常更新的字段（点赞数 等） 尽量重新分表  垂直分表
...
alter table `file` add column (`key` varchar(32) comment '文件表示');
