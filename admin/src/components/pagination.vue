<template>
    <div class="pagination" role="group" aria-label="分页">
        ...
        <button v-for="p in pages" v-bind:id="'page-'+p" :key="p.num" type="button" class="btn btn-default btn-white btn-round"
...
<script>
    export default {
        ...
        props: {
            ...
            itemCount: Number //显示的页码数 比如总共100页 只显示10页 其他用省略号代替
        },
        data: function () {
            //组件内部变量定义
            return {
